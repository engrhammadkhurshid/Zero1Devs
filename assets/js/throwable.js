(!(function (t) {
  ...
  const e = function (t, e) {
      return (
        ...
        function (i, s) {
          for (
            var n = Math.max(arguments.length - e, 0), o = Array(n), h = 0;
            h < n;
            h++
          )
            o[h] = arguments[h + e];
  ...
  window.tpDebounce = function (t, s, n) {
    var o,
      h,
      r = function (e, i) {
        ((o = null), i && (h = t.apply(e, i)));
      },
      a = e(function (e) {
        if ((o && clearTimeout(o), n)) {
          var a = !o;
          ((o = setTimeout(r, s)), a && (h = t.apply(this, e)));
        } else o = i(r, s, this, e);
        return h;
      });
    return (
  ...
  const s = "tpThrowable";
  let n = { roundness: "sharp", scrollGravity: !1 };
  class o {
    constructor(e, i) {
      ((this._defaults = n),
        (this._name = s),
        ...
        (this.DOM = {}),
        (this.DOM.element = e),
        (this.DOM.$element = t(e)),
        (this.DOM.throwables = this.DOM.element.querySelectorAll(
          "[data-throwable-el]",
        )),
        (this.onWindowResize = tpDebounce(this.onWindowResize.bind(this), 100)),
        (this.bodies = []),
        this.init());
    }
    init() {
      ...
      new IntersectionObserver(([t], e) => {
        t.isIntersecting &&
          (this.DOM.throwables.forEach((t) => {
            gsap.to(t, { opacity: 1, duration: 0.35 });
          }),
          this.startRain(),
          e.disconnect());
      }).observe(this.DOM.element);
    ...
    updateBoundries() {
      (this.boundTop &&
        Matter.Body.setVertices(
          this.boundTop,
          Matter.Bodies.rectangle(0, -100, 2 * this.width, 200, {
            isStatic: !0,
          }).vertices,
        ),
        this.boundStart &&
        ...
        this.boundBottom &&
          ...
          Matter.Body.setVertices(
            this.boundBottom,
            Matter.Bodies.rectangle(0, this.height + 100, 2 * this.width, 200, {
              isStatic: !0,
            }).vertices,
          )));
    }
  ...
  t.fn[s] = function (e) {
    return this.each(function () {
      const i = { ...t(this).data("throwable-options"), ...e };
      t.data(this, "plugin_" + s) ||
        t.data(this, "plugin_" + s, new o(this, i));
    });
  };
})(jQuery),
  jQuery(document).ready(function (t) {
    t("[data-throwable-scene]").tpThrowable();
  }));
