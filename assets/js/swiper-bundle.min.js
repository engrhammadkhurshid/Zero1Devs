    ...
    function (e) {
      ...
      function P() {
        ...
        (t.params.uniqueNavElements &&
          ...
          i &&
            ((r = i.querySelector(te(t.params.scrollbar.dragClass))),
    ...
    function (e) {
      ...
      function P(e) {
        ...
        if (((u = !1), (m = !1), h.push(e), !(h.length < 2))) {
          if (((u = !0), (g.scaleStart = S()), !g.slideEl)) {
      ...
      function L(e) {
        ...
        (i >= 0 && (h[i] = e),
          h.length < 2 ||
            ...
            (g.scaleMove = S()),
            g.imageEl &&
              ((a.scale = (g.scaleMove / g.scaleStart) * l),
              a.scale > g.maxRatio &&
      ...
      function A(e) {
        ...
        const a = t.zoom;
        if (!g.imageEl) return;
        if (!v.isTouched || !g.slideEl) return void (s && O(e));
        ...
        (e.cancelable && e.preventDefault(),
          ...
          (v.isMoved = !0));
        const n = (a.scale - l) / (g.maxRatio - t.params.zoom.minRatio),
          { originX: c, originY: p } = g;
        ((v.currentX =
          v.touchesCurrent.x -
          v.touchesStart.x +
          v.startX +
      ...
      function O(e) {
        ...
        const a = -3 * (e.clientX - p.x),
          ...
          h = -m,
          f = Math.min(u / 2 - o / 2, 0),
          w = -f,
          b = Math.max(Math.min(v.startX + a, h), m),
      ...
      function D(e) {
        ...
        let i, r, o, d, c, p, u, m, h, b, y, x, S, M, C, P, L, I;
        (t.params.cssMode &&
          ((t.wrapperEl.style.overflow = "hidden"),
        ...
        ((s.scale = z || A),
          ...
          !e || (1 === l && z)
            ...
            : ((L = g.slideEl.offsetWidth),
              ...
              (o = w(g.slideEl).left + n.scrollX),
              (d = w(g.slideEl).top + n.scrollY),
              (c = o + L / 2 - i),
              (p = d + I / 2 - r),
              ...
              m < M && (m = M),
              m > P && (m = P)),
          z && 1 === s.scale && ((g.originX = 0), (g.originY = 0)),
      ...
      const i = (e, s) => {
        let a = t.isHorizontal()
          ...
          i = t.isHorizontal()
            ? e.querySelector(".swiper-slide-shadow-right")
            : e.querySelector(".swiper-slide-shadow-bottom");
        (a || (a = ce("flip", e, t.isHorizontal() ? "left" : "top")),
          i || (i = ce("flip", e, t.isHorizontal() ? "right" : "bottom")),
        ...
        setTranslate: () => {
          ...
          for (let s = 0; s < e.length; s += 1) {
            ...
            if ((f && g.shadow) || !f) {
              ...
              if ((!e && g.shadow && (e = ce("creative", a)), e)) {
